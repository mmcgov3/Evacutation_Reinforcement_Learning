...
output_dir = output_dir + '/Continuum_2Exits_DQN_Fully'
model_saved_path = model_saved_path + '/Continuum_2Exits_DQN_Fully'    
name_mainQN = 'main_qn_2exits'    
name_targetQN = 'target_qn_2exits'
