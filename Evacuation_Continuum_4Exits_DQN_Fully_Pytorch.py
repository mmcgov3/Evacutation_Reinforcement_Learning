...
output_dir = os.path.join(output_dir, 'Continuum_4Exit_DQN_Fully_Pytorch')
model_saved_path = os.path.join(model_saved_path, 'Continuum_4Exit_DQN_Fully_Pytorch')

name_mainQN = 'main_qn_4exit'
name_targetQN = 'target_qn_4exit'
